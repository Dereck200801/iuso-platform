...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`🔄 Tentative de suppression du compte Auth: ${userId}`)
    ...
    console.log(`✅ Compte Auth supprimé avec succès: ${userId}`)
    ...
    console.error('Erreur dans auth-rollback:', error)
    return new Response(
      JSON.stringify({ 
